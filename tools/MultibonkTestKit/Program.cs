...
{
    /// <summary>
    /// MultibonkTestKit - a plain .NET console app that impersonates a second Multibonk
    /// client so the host-authoritative co-op mod can be tested from a single machine.
    /// See README.md for usage and the interactive key legend.
    /// </summary>
